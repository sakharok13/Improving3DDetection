    ...
    def prepare_data_ssl_unlabel(self, data_dict, output_dicts):
        ...
        if 'student' in output_dicts:
            if self.contrastive:
                ...
                if 'gt_names' in student_data_dict_view1:
                    student_data_dict['gt_names'] = []
                    student_data_dict['gt_names'].append(student_data_dict_view1['gt_names'])
                    student_data_dict['gt_names'].append(student_data_dict_view2['gt_names'])
                else:
                    student_data_dict['gt_names'] = [[], []]
                if 'gt_boxes' in student_data_dict_view2:
                    student_data_dict['gt_boxes'] = []
                    student_data_dict['gt_boxes'].append(student_data_dict_view1['gt_boxes'])
                    student_data_dict['gt_boxes'].append(student_data_dict_view2['gt_boxes'])
                else:
                    student_data_dict['gt_names'] = [[], []]
