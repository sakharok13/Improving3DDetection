...
from .pseudo_label import pseudo_label, proficient_teachers
from .iou_match_3d import iou_match_3d
from .se_ssd import se_ssd
from .semidet3d import semidet3d_pseudo, semidet3d_pseudo_consis

semi_learning_methods = {
    'SESS': sess,
    'Pseudo-Label': pseudo_label,
    'ProficientTeachers': proficient_teachers,
    '3DIoUMatch': iou_match_3d,
    'SE_SSD': se_ssd,
    'SemiDet3D_Pseudo': semidet3d_pseudo,
    'SemiDet3D_Pseudo_Consis': semidet3d_pseudo_consis
}
