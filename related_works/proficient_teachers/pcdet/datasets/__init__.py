...
from .waymo.waymo_semi_dataset import WaymoPretrainDataset, WaymoLabeledDataset, WaymoUnlabeledDataset, WaymoTestDataset, split_waymo_semi_data
...
_semi_dataset_dict = {
    ...
    'WaymoDataset': {
        'PARTITION_FUNC': split_waymo_semi_data,
        'PRETRAIN': WaymoPretrainDataset,
        'LABELED': WaymoLabeledDataset,
        'UNLABELED': WaymoUnlabeledDataset,
        'TEST': WaymoTestDataset
    }
}
