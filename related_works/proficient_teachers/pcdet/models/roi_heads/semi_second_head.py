...
class SemiSECONDHead(RoIHeadTemplate):
    ...
    def visualization(self, points, pred_boxes, token, name='', gt=None):
        ...
        save_dir = '/ssd/junbo/repository/SemiDet3D/output/visual/{}'.format(name)
    ...
    def roi_grid_pool(self, batch_dict):
        ...
        # self.visualization(batch_dict['points'], batch_dict['rois'], batch_dict['frame_id'], 'debug_iou', None)
    ...
    def forward(self, batch_dict):
        ...
        # (testing, return filtered boxes and iou scores)
            ...
            targets_dict = self.proposal_layer(           # generate proposal box from all the anchors
                batch_dict, nms_config=self.model_cfg.NMS_CONFIG['TEST']
            )
